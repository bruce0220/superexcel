 ...
 * @version 1.0.0
 */
@ExportedSheetDefine(sheetName = "测试sheet1", defaultColumnWidth = 10)
public class ExcelExportEo1 implements ExcelExportEo {
	...
	@ExportedHeaderDefine(headerName = "自定义格式时间", cellWidth = 20)
	@CellExportedTypeDefine(toCellType = CellExportedType.DATE, dateFormat = "yyyy-MM-dd")
	...
	@ExportedHeaderDefine(headerName = "时间2")
	@CellExportedTypeDefine(toCellType = CellExportedType.DATE, dateFormat = "yyyy-MM-dd hh")
	private Date date2;
